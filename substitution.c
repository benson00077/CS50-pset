...
int key_val(int c, string v)
{
    ...
    else if (c == 2)
    {
        ...
        else if (checker == 26)
        {
            ...
            if (checker2 > strlen(v)) /// if checker2 > strlen(ca), there is repeated char in the array ca. 
            {
                printf("%s\n", "Key must contain 26 characters."); 
                return 1;
            }
    ...
    return 1; /// if without this line, ERROR:  control may reach end of non-void function 
}
